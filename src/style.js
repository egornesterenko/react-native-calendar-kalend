...
export const textLinkColor = '#153d73';
...
export const agendaDayTextColor = '#153d73';
export const agendaDayNumColor = '#153d73';
export const agendaTodayColor = textLinkColor;
export const agendaKnobColor = Platform.OS === 'ios' ? '#f2F4f5' : '#153d73';
